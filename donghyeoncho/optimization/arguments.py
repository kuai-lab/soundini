...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--frame_num", type=int, help="The number of frame", default=-1) # -1이면 폴더 안 전부 하는 것
    ...
    parser.add_argument(
        "--sound_guidance_lambda",
        type=float,
        help="Controls how much the image should look like the sound",
        default=1000,
    )
    parser.add_argument(
        "--range_lambda",
    ...
    parser.add_argument(
        "--l2_sim_lambda", type=float, help="The L2 similarity to the input image", default=100,
    )
    # parser.add_argument(
    #     "--lpips_sim_lambda",
    #     type=float,
    ...
    # )
    # parser.add_argument(
    #     "--l2_sim_lambda", type=float, help="The L2 similarity to the input image", default=1000,
    # )
    parser.add_argument(
    ...
    parser.add_argument(
        "--optical_flow_loss",
        help="Indicator for using the optical flow loss",
        type=float,
        default=5000,
    )
    ...
    # Misc
    parser.add_argument("--seed", type=int, help="The random seed", default=99)
    parser.add_argument("--gpu_id", type=int, help="The GPU ID", default=0)
    parser.add_argument("--output_path", type=str, default="output")
    parser.add_argument("--one_data", type=str, default="")
    parser.add_argument(
        "-o",
        "--output_file",
        type=str,
