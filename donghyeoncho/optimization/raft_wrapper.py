...
sys.path.append('./optimization/thirdparty/RAFT/core')
sys.path.append('./optimization/thirdparty/RAFT/core/utils')
from optimization.thirdparty.RAFT.core.utils.utils import InputPadder
from optimization.thirdparty.RAFT.core.raft import RAFT
from optimization.thirdparty.RAFT.core.utils import flow_viz

# sys.path.remove('./optimization2/thirdparty/RAFT/core')
...
class RAFTWrapper():
    def __init__(self, model_path, max_long_edge=900):
        ...
        self.model.load_state_dict(torch.load("/home/lsh/blended-diffusion/optimization/thirdparty/RAFT/models/raft-things.pth"))
